...
async def build_psbt_request(vault_id: str, vault_address: str, psbt_hex_data: str, will_auto_finalize: bool, uses_custom_rpc: bool = False, num_inputs: int = 1) -> dict[str, Any]:

...
async def strk_tx_erc20(chain: str, vault_id: str, destination: str, custom_note: str, value: str, contract: str):
    request_json = {
...
erc20_token_contract = "0x053c91253bc9682c04929ca02ed00b3e423f6710d2ee7e0d5ebb06f3ecf368a8" # Stargate USDC.e
...
value = str(100_000) # 0.1 USDC.e (1 USDC.e = 1000000 units)

async def main():
    try:
        ## Building transaction
        request_json = await strk_tx_erc20(chain=chain, vault_id=STARKNET_VAULT_ID, destination=destination, custom_note=custom_note, value=value, contract=erc20_token_contract)

...
import { SOLANA_DEPLOY_CONTRACT_FORDEFI_PROGRAM_ADDRESS } from "../programs";
...
export type InitializeInstruction<
  TProgram extends string =
    typeof SOLANA_DEPLOY_CONTRACT_FORDEFI_PROGRAM_ADDRESS,
...
>(config?: {
  ...
  const programAddress =
    config?.programAddress ?? SOLANA_DEPLOY_CONTRACT_FORDEFI_PROGRAM_ADDRESS;
